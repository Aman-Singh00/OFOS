...
public class OFOS_MyOrders_019 extends Base_Test {

	@Test
	public void placedOrderFromHeavenIndianRestaurant() {
		...
		clickAction(page.getHellRestaurantLink());

		test.log(LogStatus.PASS, "clicked successfully on heaven link");
